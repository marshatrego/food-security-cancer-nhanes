*Cancer - One type, Unknown(99) and nonmelanoma/unknown skin(32&33) excluded;
...
proc sort data=work.medq_fsq_4yr;
	by cancertype mcq230a fi_bin fsdad ridageyr;
run;
proc print data=work.medq_fsq_4yr;
	var cancertype mcq230a fi_bin fsdad ridageyr;
run;
...
title 'Average age of diagnosis for all people over age 19 with a history of one type of cancer';
title2 'Unknown cancer and Nonmelanoma skin cancer excluded'
...
Title '4 Year (2011-14) Weighted Frequencies';
Title2 'All people with 1 type of cancer >19yrs, Unknown cancer and nonmelanoma skin cancer excluded';
proc surveyfreq data=work.medq_fsq_4yr;
	stratum sdmvstra;
	cluster sdmvpsu;
	weight wtint4yr;
	tables 
			cancertype*fi_bin
			age1*cancertype*fi_bin				/*Age1 = Divided by 52 (Avg agediagnosis)*/
			time_diag2*fi_bin
...
run;
title 'Sociodemographic Info All People with cancer >19 Years, Unknown cancer and nonmelanoma skin cancer excluded';
proc surveyfreq data=work.medq_fsq_4yr;
	stratum sdmvstra;
	cluster sdmvpsu;
	weight wtint4yr;
