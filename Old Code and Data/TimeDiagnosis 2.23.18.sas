data work.medq_fsq;
	...
	where 19<ridageyr and mcq220=1 and mcq230b=. and fsdad ne . and mcq240e<1000;
...
proc sort data=work.medq_fsq;
	by cancertype time_diag ;
run;
proc print data=work.medq_fsq;
	var cancertype time_diag1 time_diag ridageyr age_diag  
	;
run;
...
proc surveyfreq data=work.medq_fsq;
	...
	cluster sdmvpsu;
	weight wtint2yr;
	tables cancertype*Time_diag1*fi_bin/ chisq1;
run;