...
proc surveylogistic data=work.medq_fsq_4yr_all;
	...
	cluster sdmvpsu;
	weight wtint4yr;
	class  cancer (param=ref ref=first) riagendr (param=ref ref=first) ridreth1 (param=ref ref=first) incomegroup insurance education ;
	*domain cancer;
...
proc surveylogistic data=work.medq_fsq_4yr_all;
	...
	cluster sdmvpsu;
	weight wtint4yr;
	class  cancertype (param=ref ref=first) cancer  (param=ref ref=last) riagendr (param=ref ref=first) ridreth1 (param=ref ref=first) incomegroup insurance education ;
	domain cancer;
	format ridreth1 raceth. riagendr gender. mcq220 cancer.;
