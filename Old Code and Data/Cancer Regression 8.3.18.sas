...
data work.medq_fsq_4yr_all;
	...
	where 19<ridageyr and fsdad ne . and mcq220=1 /*and mcq230b=.*/;
	length fi_bin $13;
...
proc surveylogistic data=work.medq_fsq_4yr_all;
	...
	cluster sdmvpsu;
	weight wtint4yr;
	class  age time_diag2 (param=ref ref=first) cancertype (param=ref ref=first) 
		riagendr (param=ref ref=first) ridreth1 (param=ref ref=first) partner children
		 insurance education (param=ref ref=first) pir (param=ref ref=first);
