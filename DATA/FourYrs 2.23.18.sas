data work.medq_fsq_4yr;
	...
	where 19<ridageyr and mcq220=1 and mcq230b=. and fsdad ne . and mcq230a ne 99;
...
run;
		...
		/**********************************************************************/
		/**********************************************************************/
		/*******************Same as above but excludes FRep********************/
		/*******************and Unknown****************************************/
		/**********************************************************************/
		/**********************************************************************/
		/**********************************************************************/
data work.medq_fsq_4yr1;
	set sasfile.medq_fsq_4yr;
...
run; 
Title color=indianred '4 Year (2011-14) Weighted Frequencies'; 
Title2 color=palevioletred 'All people with 1 type of cancer >19yrs w/o Resp or Unknown Cancer or FRep cancer';
proc surveyfreq data=work.medq_fsq_4yr1;
	stratum sdmvstra;
	cluster sdmvpsu;
	weight wtint4yr;
	tables 
